        ...
        "Процедуры и функции взаимодействия с системой": {
            ...
            "methods": {
                ...
                "ЗагрузитьСценарий": {
                    ...
                    "name_en": "LoadScript",
                    "signature": "(path: Строка, externalContext?: Структура): ИнформацияОСценарии",
        ...
        "МенеджерФайловыхПотоков": {
            ...
            "methods": {
                ...
                "ОткрытьДляЗаписи": {
                    ...
                    "signature": "(fileName: Строка) : ФайловыйПоток",
        ...
        "Рефлектор": {
            ...
            "methods": {
                "ВызватьМетод": {
                    "name": "ВызватьМетод",
                    "name_en": "CallMethod",
                    "signature": "(target: ИнформацияОСценарии, methodName: Строка, arguments?: Массив): Произвольный|Неопределено",
                ...
                "МетодСуществует": {
                    ...
                    "signature": "(target: ИнформацияОСценарии, methodName: Строка): Булево",
                ...
                "ПолучитьТаблицуМетодов": {
                    ...
                    "signature": "(target: ИнформацияОСценарии): ТаблицаЗначений",
        ...
        "ОписаниеТипов": {
            ...
            "methods": {
                ...
                "СодержитТип": {
                    ...
                    "signature": "(type: Произвольный) : Булево"
                },
                "ПривестиЗначение": {
                    "name": "ПривестиЗначение",
                    "name_en": "AdjustValue",
                    "signature": "(value?: Произвольный) : Произвольный"
                }
            },
            "constructors": {
                "ПоУмолчанию": {
        ...
        "КонтекстПространствИменXML": {
            ...
            "methods": {
                ...
                "НайтиURIПространстваИмен": {
                    ...
                    "signature": "(prefix: Строка) : Произвольный"
                },
                "НайтиПрефикс": {
                    "name": "НайтиПрефикс",
                    "name_en": "LookupPrefix",
                    "signature": "(namespaceUri: Строка) : Произвольный"
                },
                "Префиксы": {
                    "name": "Префиксы",
                    "name_en": "Prefixes",
                    "signature": "(namespaceUri: Строка) : Массив"
                },
        ...
        "СписокЗначений": {
            ...
            "methods": {
                ...
                "Добавить": {
                    "name": "Добавить",
                    "name_en": "Add",
                    "signature": "(value: Произвольный, presentation?: Строка, check?: Булево, picture?: Произвольный): ЭлементСпискаЗначений"
                },
                "Вставить": {
                    "name": "Вставить",
                    "name_en": "Insert",
                    "signature": "(index: Число, value: Произвольный, presentation?: Строка, check?: Булево, picture?: Произвольный): ЭлементСпискаЗначений"
                },
                "ВыгрузитьЗначения": {
        ...
        "ДвоичныеДанные": {
            ...
            "methods": {
                ...
                "ОткрытьПотокДляЧтения": {
                    ...
                    "returns": "Возвращает поток данных, который можно последовательно читать и/или в который можно последовательно писать. Экземпляры объектов данного типа можно получить с помощью различных методов других объектов."
                }
            },
            "constructors": {
                "На основании файла": {
