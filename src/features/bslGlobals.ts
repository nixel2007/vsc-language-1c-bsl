  ...
  let data = {
    "ru": {
      ...
      "ПараметрыДоступа": {
        ...
        signature: {
          default: {
            СтрокаПараметров: '(НаименованиеПрава: Строка, ОбъектМетаданных: Произвольный, СписокПолей: Строка, Пользователь/Роль?: ПользовательИнформационнойБазы): ПараметрыДоступа',
            Параметры: {
      ...
      "ПравоДоступа": {
        ...
        signature: {
          default: {
            СтрокаПараметров: '(Право: Строка, ОбъектМетаданных: ОбъектМетаданных: Куб, Пользователь/Роль?: ПользовательИнформационнойБазы, СтандартныйРеквизитСтандартнаяТабличнаяЧасть?: Строка): Булево',
            Параметры: {
      ...
      "СтрШаблон": {
        ...
        signature: {
          default: {
            СтрокаПараметров: '(Шаблон: Строка, Значение1-Значение10?: Произвольный): Строка',
            Параметры: {
