...
export function globalfunctions(): any {
    let data = {
        ...
        "ОтключитьОбработчикЗапросаНастроекКлиентаЛицензирования": {
            ...
            description: 'Отключает обработчик запроса настройки клиента лицензирования, подключенный ранее при помощи УстановитьКнопки .'
        },
        ...
        "ПравоДоступа": {
            ...
            signature: {
                default: {
                    СтрокаПараметров: '(Право: Строка, ОбъектМетаданных: ОбъектМетаданных: HTTPСервис, Пользователь_Роль?: ПользовательИнформационнойБазы, СтандартныйРеквизитСтандартнаяТабличнаяЧасть?: Строка): Булево',
                    Параметры: {
        ...
        "РабочийКаталогДанныхПользователя": {
            ...
            description: 'Предоставляет доступ к каталогу текущего пользователя данн/ой информационной базы внутри стандартного каталога данных приложения.',
...
export function classes() {
    return {
        ...
        "HTTPСоединение": {
            ...
            description: 'Предназначен для работы с файлами на http-серверах.  Поддерживаются следующие протоколы: HTTP 1.0 и HTTP 1.1. Для защиты соединения может быть использован протокол TLS 1.0.',
            methods: {
                "ВызватьHTTPМетод": {
        ...
        "ДвоичныеДанные": {
            ...
            methods: {
                "Записать": {
                    name: 'Записать',
                    name_en: 'Write',
                    description: 'Записывает двоичные данные в файл.',
                    signature: {
                        default: {
                            СтрокаПараметров: '(ИмяФайла: Строка)',
                            Параметры: {
                                ИмяФайла: 'Имя файла, в который необходимо записать двоичные данные. Если файл существует, он будет перезаписан, иначе - создан.'
                            }
                        }
                    }
                },
            ...
            constructors: {
                "На основании файла": {
                    description: 'Создает объект и помещает в него двоичные данные, взятые из файла. В режиме веб-клиента недоступен.',
                ...
                "ОткрытьФайл": {
                    ...
                    signature: {
                        ПоИмениИТипуКодировки: {
                            СтрокаПараметров: '(ИмяФайлаXML: Строка, ТипКодировки?: Строка)',
                            Параметры: {
                        ...
                        СПараметрамиЗаписи: {
                            СтрокаПараметров: '(ИмяФайлаXML: Строка, ПараметрыЗаписи: ПараметрыЗаписиXML)',
                            Параметры: {
                                ИмяФайлаXML: 'Имя файла, в который будет записываться текст XML.',
        ...
        "ЗаписьZipФайла": {
            ...
            methods: {
                ...
                "Открыть": {
                    ...
                    signature: {
                        default: {
                            СтрокаПараметров: '(ИмяФайла: Строка, Пароль?: Строка, Комментарий?: Строка, МетодСжатия?: МетодСжатияZIP, УровеньСжатия?: УровеньСжатияZIP, МетодШифрования?: МетодШифрованияZIP)',
                            Параметры: {
